...
public:
    virtual void afisare() = 0; // metoda virtuala pura
    virtual void listare() = 0;
};

class Lungmetraj :public Interfata {
private:
    string denumire;
    int an;
    int nrOre;
...
public:
    ...
    Lungmetraj(string denumire, int an, int nrOre)
    {
    ...
    virtual void afisare()
    {
        ...
        cout << "Anul 2011: " << an << endl;
        cout << "Numar ore : " << nrOre << endl;
    }
    ...
    void setDenumire(string denNou) {
        denumire = denNou;
    } 
    ...
    friend ostream& operator <<(ostream& o, Lungmetraj& sursa) {
        
        o << "Denumire: " << sursa.denumire << endl;
        o << "Anul: " << sursa.an << endl;
        o << "Numar ore: " << sursa.nrOre << endl;
        return o;
    }
...
class Spectator : public Lungmetraj
{
private :
    string nume;
    int nrLoc;
...
public:
    ...
    Spectator(string denumire, int an, int nrOre, string nume, int nrLoc, float pretBilet) :Lungmetraj(denumire, an, nrOre)
    {
        this->nume = nume;
        this->nrLoc = nrLoc;
    ...
    Spectator(Spectator& sursa) :Lungmetraj(sursa)
    {
        this->nume = sursa.nume;
        this->nrLoc = sursa.nrLoc;
        this->pretBilet = sursa.pretBilet;

    }

    void afisare() {
        Lungmetraj::afisare();
        cout << "Numele este: Destinul " << endl;
        cout << "Numarul locului este: 34 " << endl;
        cout << "Pretul biletului este: 23 " << endl;
    }

    void listare() {
        Lungmetraj::afisare();
        cout << "Numele este: Mumia " << endl;
        cout << "Numarul locului este: 20 " << endl;
        cout << "Pretul biletului este: 30 " << endl;
    }
...
{
    string denumire;
    Bilet* bilet; //compunere prin pointer unde retinem adresa unui Bilet
...
public:
    ...
    Scurtmetraj(const char* denumire, int* ratingEpisoade, int nrEpisoade, int nrMinute) : Film(denumire, ratingEpisoade, nrEpisoade)
    {
    ...
    ostream& operator << (ostream& iesire, Scurtmetraj& sc)
    {
        ...
        iesire << (Film)sc; // am facut la sc cast la film
        iesire << sc.getNrMinute() << endl;
        return iesire;
...
int main()
{
   ...
   /* Sala s1;
    ...
    /*Lungmetraj l1("Adela", 2021, 2);
    Spectator sp;
    Spectator sp1("Hulk", 2000, 2, "Draghici", 27, 34);
    Spectator sp2(sp1);
    sp.afisare();
    sp.listare();
    l1.afisare();
